...
def load_and_transform_vision_data_blip(image_paths, device, training=False):
    if image_paths is None:
        return None
...
def load_and_transform_video_data_blip(
    ...
    for all_video in video_paths:
        if all_video is not None:
            ...
            all_video = torch.zeros(int(30/clip_duration*sample_per_clip), 3, 224, 224)
